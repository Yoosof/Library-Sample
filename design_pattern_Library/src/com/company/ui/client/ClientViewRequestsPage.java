 ...
 */
public class ClientViewRequestsPage extends ClientPage{
    ...
    public ClientViewRequestsPage(List<RequestBook> requestBooks) {
        super();
    ...
    public void setActions(){
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                new ClientRequestClickPage(requestBooks.get(table.getSelectedRow()));
                closePage();
            }
        });
    }
